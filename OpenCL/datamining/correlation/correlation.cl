...
__kernel void std_kernel(__global DATA_TYPE *mean, __global DATA_TYPE *std, __global DATA_TYPE *data, DATA_TYPE float_n, DATA_TYPE eps, int m, int n, int cX, int cY) 
{
...
__kernel void reduce_kernel(__global DATA_TYPE *mean, __global DATA_TYPE *std, __global DATA_TYPE *data, DATA_TYPE float_n, int m, int n, int cX, int cY) 
{
...
__kernel void corr_kernel(__global DATA_TYPE *symmat, __global DATA_TYPE *data, int m, int n)
{
	...
	//for (int x = 0; x < cX; x++) {
		...
		//int j1 = (get_group_id(0) * cX + x) * get_local_size(0) + get_local_id(0);	
