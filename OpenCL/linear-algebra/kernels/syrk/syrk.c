...
void cl_launch_kernel(int ni, int nj, DATA_TYPE alpha, DATA_TYPE beta, DATA_TYPE POLYBENCH_2D(C,NJ,NI,nj,ni))
{
...
int main(int argc, char *argv[])
{
	...
	cl_launch_kernel(ni, nj, alpha, beta, POLYBENCH_ARRAY(C));
